...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("Give fast the player should move when running around.")]
	...
	[SerializeField]
	[Tooltip("")]
	private AudioClip healthPillClip;
	...
	private void FixedUpdate()
	{
		...
		if (p_Velocity.sqrMagnitude > 0)
		{
			...
			cc_Rb.rotation = Quaternion.Slerp(cc_Rb.rotation, cc_Rb.rotation * Quaternion.Euler(0, theta, 0), .2f);
		}
	}
    #endregion
